...
rg -q '^  api:$' "$COMPOSE"
rg -q '"3001:3001"' "$COMPOSE"
rg -q 'VEMS_DB_PATH: /var/lib/vems/data/platform.sqlite' "$COMPOSE"
rg -q '../services/api-gateway/.data:/var/lib/vems/data:rw' "$COMPOSE"
...
rg -q 'VEMS_REQUIRE_EXISTING_DB: "true"' "$COMPOSE"
