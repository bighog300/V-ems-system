...
export default function EpcrScreen({ patientCaseId, session, onBack }: EpcrScreenProps) {
  ...
  return (
    <ScrollView style={styles.container} testID="epcr-screen">
      ...
      <Text style={styles.title}>ePCR status</Text>
      <Text style={styles.stateLabel} testID="epcr-state">
        {stateLabel(state)}
      </Text>

      {error ? (
        <Text style={styles.error} testID="epcr-error">
          {error}
        </Text>
      ) : null}
      ...
      {state === "crew_complete" ? (
        <View style={styles.card}>
          ...
          />
          <Pressable style={[styles.button, busy && styles.buttonDisabled]} onPress={handleSign} disabled={busy} testID="sign-epcr">
      ...
      {state === "signed" ? (
        <View style={styles.card}>
          ...
          <Pressable style={[styles.button, busy && styles.buttonDisabled]} onPress={handleSubmit} disabled={busy} testID="submit-epcr">
